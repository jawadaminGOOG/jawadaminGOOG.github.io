...
## Past Work (AI Accelerators & Agentic Systems)

* **[WorkbenchIQ](https://github.com/JawadAminMSFT/WorkbenchIQ)**  
  Enterprise solution accelerator providing a modern workbench for underwriters and claims processors, combining AI Content Understanding and AI Foundry capabilities.
* **[agentic-diligence-ibanking](https://github.com/JawadAminMSFT/agentic-diligence-ibanking)**  
  AI-first agentic M&A due diligence platform powered by the Copilot SDK.
...
* **[mike-ai-agent](https://github.com/JawadAminMSFT/mike-ai-agent)**  
  Speech-to-Action AI agent implementation.
* **[credit-card-agentic](https://github.com/JawadAminMSFT/credit-card-agentic)**  
  AI-powered application system built with modern agent frameworks for autonomous multi-agent approvals.
* **[document_indexer_gpt](https://github.com/JawadAminMSFT/document_indexer_gpt)**  
  PDF data extraction application using OpenAI vision models.

[View all past repositories on GitHub ↗](https://github.com/JawadAminMSFT?tab=repositories)
